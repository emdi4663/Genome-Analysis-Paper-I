...
out_dir=/proj/uppmax2024-2-7/private/04_diff_expression_analysis
...
#Convering the .sam files to .bam, followed by sorting of the .bam files 
for samfile in $out_dir/*_mapped.sam; do
